...
{id:1,value:'participantRegistrationForm',title:'All participants completed a sign in sheet at the start of the session.'},
{id:2,value:'eventStartedOnTime',title:'The event started on time.'},
{id:3,value:'eventFinishedOnTime',title:'The event finished on time.'},
{id:4,value:'participantGreeted',title:'Participants were greeted by someone from the program when they entered.'},
{id:5,value:'resourcesAvailable',title:'Resources were available to participants.'},
{id:6,value:'photoRelease',title:'If photos were taken, participants signed a photo usage form.'},
{id:7,value:'handSanitizerAvailable',title:'Hand sanitizer was available.'},
{id:8,value:'reminderSafeSpace',title:'Participants were reminded that the workshop area is a safe space and to treat each other respectfully and within the workshop guidelines.'},
{id:9,value:'reminderPostEvaluationSurvey',title:'All participants completed a post-workshop evaluation form.'},
{id:10,value:'Are sign-in sheets from last week up to date and stored appropriately?',title:'Are sign-in sheets from last week up to date and stored appropriately?'},
  ...
  return (
    <>
      ...
      <div className="container mx-auto border-black rounded-lg mb-10">
       ...
       <FacilitatorName eventForm={eventForm} setEventForm={setEventForm} stateValue={'externalFacilitator'}/>
...
<DropboxDocumentUpload title='Please upload the meeting agenda. Choose File '/>
<DropboxDocumentUpload title='Please upload the meeting agenda. Choose File '/>
