...
const success = () => {
  ...
  return (
    <div className='container mx-auto flex gap-10 flex-col justify-items-center items-center h-screen'>
    <div className="h-88  py-10 px-10  mt-3 flex flex-col gap-5 items-center rounded-lg border-black">
          ...
          <section className='flex flex-col mt-10 py-7 w-full gap-5 bg-[#A1EDD2] rounded-lg items-center'>
        ...
        <button onClick={() => router.back()} className='uppercase rounded shadow bg-black text-white text-2xl px-5 py-2 '>Submit another participant sign-in sheet</button>
        </div>
