...
export default function EventsCardItems({programName,eventdate,eventName,urlEdit,urlParticipantSurvey,urlUpload,urlPostEventSurvey}) {
  return (
    <div className="events-card-item shadow-lg rounded-lg border p-5">
        ...
        <div className="h-20">
        <p className=" rounded-lg py-1 px-2 ">{eventName}</p>
        </div>
        <div className="events-card-item-btn-container grid md:grid-cols-2 grid-cols-2 gap-5 my-3 ">
            <Link href={urlEdit}>
        <div className="events-card-item-btn bg-white text-black border-black p-5 flex justify-center items-center rounded-lg cursor-pointer">
