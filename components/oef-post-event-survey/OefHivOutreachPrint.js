    ...
    <div ref={ref}>
      <div className="flex items-center gap-x-52 container mx-auto px-5 py-3 my-1 ">
        {/* <img
          ...
          width={45}
        /> */}
        <h2 className="font-black mb-2 justify-self-center text-center mt-2 mb-2">
          OEF HIV Outreach
        </h2>
      </div>
      ...
      <div className="container mx-auto px-7 text-xs">
        ...
        <div className=" my-5">
          ...
          <p>
            {event?.partnerorganization1.charAt(0) === ","
              ? event?.partnerorganization1.replace(",", "")
              : event?.partnerorganization1}
          </p>
        ...
        <div className="flex gap-x-1 my-5">
          <h3 className="font-black mb-2">Total number of people at event:</h3>
          <p>{event?.totalattendees}</p>
        </div>
        <h3 className="font-black mb-2 my-5">Resources Distributed</h3>
        <div className="flex gap-x-1 my-5">
          <h3 className="font-black mb-2">HIV literature: </h3>
          <p>{event?.hivliterature}</p>
        </div>

        <div className="flex gap-x-1 my-5">
          <h3 className="font-black mb-2">HepC literature: </h3>
        ...
        <div className="flex gap-x-1 my-5">
          <h3 className="font-black mb-2">Health disparities literature: </h3>
          <p>{event?.healthdisparitiesliterature}</p>
        </div>
        <div className="flex gap-x-1 my-5">
          <h3 className="font-black mb-2">Bags/boxes of food: </h3>
          <p>{event?.bagsboxesfood}</p>
        </div>
        <div className="flex gap-x-1 my-5">
          <h3 className="font-black mb-2">Masks: </h3>
          <p>{event?.masks}</p>
        </div>
        <div className="flex gap-x-1 my-5">
          <h3 className="font-black mb-2">Hand sanitizers: </h3>
          <p>{event?.handsanitizers}</p>
        </div>
        <div className="flex gap-x-1 my-5">
          <h3 className="font-black mb-2">COVID literature: </h3>
        ...
        <div className="my-5">
          <h3 className="font-black mb-2">
            How many people did you talk to, where you had a conversation about
            HIV, PrEP, or safer sex? (Please enter the total number only.)
          </h3>
        ...
        <div className="my-5">
          <h3 className="font-black mb-2">
            What were the main discussion topics people raised about HIV, PrEP,
            or safer sex?
          </h3>
          <p>{event?.eventquestions}</p>
        </div>
        <div className="my-5">
          <h3 className="font-black mb-2 mb-5">
            Event narrative: Please briefly describe the details of your event.
            Please note any highlights, such as a special guest or title of a
            film you showed that discussed HIV, PrEP and/or safer sex.
          </h3>
          <p>{event?.eventhighlights}</p>
        </div>
        <div className="my-5">
          <h3 className="font-black mb-2 mb-5">
            Event challenges: Please briefly describe any challenges you faced
            when organizing or running your event.
          </h3>
          <p>{event?.eventchallenges}</p>
        </div>
        <div className="my-5">
          <h3 className="font-black mb-2 mb-5">
            Capacity Trainings: What have you learned from the Black Health
            capacity trainings, including ALI and YIP, during this quarter? How
            was the information useful to you and the community you serve?
          </h3>
          <p>{event?.capacitytraininguseful}</p>
        </div>
        <div className="my-5">
          <h3 className="font-black mb-2 mb-5">
            Lessons Learned: Describe any new approaches or strategic lessons
        ...
        <div className="grid gap-y-5">
          <div className="mt-5">
            <h2 className="font-black mb-2 text-2xl">HIV Testing</h2>
          </div>
          ...
          <div className="grid grid-cols-3 gap-x-5">
            <h3 className="font-black mb-2">Total tested for HIV</h3>
          ...
          <div className="grid grid-cols-3 gap-x-5">
            <h3 className="font-black mb-2">
              Which services were they referred to?
            </h3>
          ...
          <div className="mt-5">
            <h3 className="font-black mb-2">
              Gender: How many people identified as the following for HIV
              Testing?
            </h3>
          </div>
          ...
          <div className="mt-5">
            <h3 className="font-black mb-2">
              Race: How many people identified with the following for racial
              identity during HIV Testing?
            </h3>
          </div>
          ...
          <div className="grid grid-cols-3 gap-x-5">
            ...
            <p>{event?.hivnativehawaiianorotherpacificislander}</p>
          </div>
          ...
          <div className="mt-5">
            <h3 className="font-black mb-2">
              Ethnicity: How many people doing HIV testing identified with the
              following Hispanic and Latin ethnicities?
            </h3>
          </div>
        ...
        <div className="grid gap-y-5">
          <div className="mt-5">
            <h2 className="font-black mb-2 text-2xl">Hepatitis C Testing</h2>
          </div>
          <div className="grid grid-cols-3 gap-x-5">
            <h3 className="font-black mb-2">Hepatitis C Testing Agency</h3>
          ...
          <div className="mt-5">
            <h3 className="font-black mb-2">
              Gender: How many people identified as the following for Hepatitis
              C Testing?
            </h3>
          </div>
          ...
          <div className="mt-5">
            <h3 className="font-black mb-2">
              Race: How many people identified with the following for racial
              identity during Hepatitis C Testing?
            </h3>
          </div>
          ...
          <div className="grid grid-cols-3 gap-x-5">
            ...
            <p>{event?.hepcnativehawaiianorotherpacificislander}</p>
          </div>
          ...
          <div className="mt-5">
            <h3 className="font-black mb-2">
              Ethnicity: How many people doing Hepatitis C testing identified
              with the following Hispanic and Latin ethnicities?
            </h3>
          </div>
        ...
        <h3 className="font-black mb-2 my-5 text-2xl">Other testing</h3>
        <div className="flex gap-x-1 my-5">
          <h3 className="font-black mb-2">
        ...
        <div className="flex gap-x-1 my-5">
          <h3 className="font-black mb-2">How many people were tested?</h3>
        ...
        <div className="flex gap-x-1 my-5">
          <h3 className="font-black mb-2">One line description: </h3>
