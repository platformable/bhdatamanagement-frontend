...
const SexualOrientationSurveySection = ({setEventForm, typeOfTest}) => {
  ...
  return (
    <div className='grid grid-cols-1 gap-5'>
      ...
      <label className='flex gap-x-5'><p className="w-60 gap-x-5">Bisexual</p><input type="number" className='border-black' name={fields[1]} onChange={handleForm} /></label>
      <label className='flex gap-x-5'><p className="w-60 gap-x-5">Queer</p><input type="number" className='border-black' name={fields[2]} onChange={handleForm} /></label>
      <label className='flex gap-x-5'><p className="w-60 gap-x-5">Questioning or not sure</p><input type="number" className='border-black' name={fields[3]} onChange={handleForm} /></label>
      <label className='flex gap-x-5'><p className="w-60 gap-x-5">Unknown</p><input type="number" className='border-black' name={fields[4]} onChange={handleForm} /></label>
      <label className='flex gap-x-5'><p className="w-60 gap-x-5">Declined to answer</p><input type="number" className='border-black' name={fields[5]} onChange={handleForm} /></label>
    </div>
  )
}
