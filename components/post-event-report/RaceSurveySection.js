...
const RaceSurveySection = ({setEventForm, typeOfTest}) => {
  ...
  return (
    ...
    <label className='flex gap-x-5'><p className="w-40">American Indian or Alaska Native</p><input type="number" className="border-black p-1" name={fields[3]} onChange={handleForm}/></label>
    <label className='flex gap-x-5'><p className="w-40">Middle Eastern or North African</p><input type="number" className="border-black p-1" name={fields[4]} onChange={handleForm}/></label>
    <label className='flex gap-x-5'><p className="w-40">Native Hawaiian or Other Pacific Islander</p><input type="number" className="border-black p-1" name={fields[5]} onChange={handleForm}/></label>
    <label className='flex gap-x-5'><p className="w-40">White</p><input type="number" className="border-black p-1" name={fields[6]} onChange={handleForm}/></label>
    <label className='flex gap-x-5'><p className="w-40">Some other race or origin</p><input type="number" className="border-black p-1" name={fields[7]} onChange={handleForm}/></label>
    <label className='flex gap-x-5'><p className="w-40">Declined to answer</p><input type="number" className="border-black p-1" name={fields[8]} onChange={handleForm}/></label>
    </div>
  )
}
