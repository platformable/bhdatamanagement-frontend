    ...
    return (
        <div className='rounded shadow grid grid-cols-6 md:h-52'>
            <div className='grid grid-rows-4 col-span-1'>
              <h2 className='bg-black row-span-1 flex justify-center items-center font-semibold text-white rounded-tl-xl'>{program}</h2>
            ...
            <div className='grid grid-rows-4 col-span-5'>
              <h2 className='bg-black row-span-1 text-white flex items-center px-5 rounded-tr-xl'>{datasetName}</h2>
                ...
                <div className='col-span-3 flex flex-col py-3 px-5 justify-between'>
                  ...
                  <div className='grid grid-cols-3'>
                    <div className='flex items-center'>
                      ...
                      <h3 className='ml-3 text-xl font-semibold '>{records} records</h3>
                    </div>
                    <div className='flex items-center'>
                      {/* <img src="/historical_data/date_icon.svg" alt="date icon"/> */}
                      <h3 className='ml-3 text-xl  font-semibold '>{dateRange}</h3>
                    </div>
                  </div>
                </div>
                <div className='bg-white flex items-center justify-center'>
                  <a className='col-span-1 rounded-md bg-black text-white text-lg flex items-center px-4 py-1 cursor-pointer'
                  download
                  href={link}
                  >
