    ...
    return (
        <div className='rounded shadow grid grid-cols-6 md:h-52'>
            <div className='grid grid-rows-4 col-span-1'>
              <h2 className='bg-yellow row-span-1 flex justify-center items-center font-semibold text-color-violet'>{program}</h2>
              <div className='bg-white row-span-3 flex justify-center'>
                <img src={programImage} alt="program icon" title="program icon" />
              </div>
            </div>
            <div className='grid grid-rows-4 col-span-5'>
              <h2 className='bg-violet row-span-1 text-white flex items-center px-5 '>{datasetName}</h2>
              <div className='bg-white grid grid-cols-4 row-span-3 gap-4'>
                ...
                <div className='bg-white flex items-center justify-center'>
                  ...
                  <img src="/historical_data/download_white_icon.svg" alt="download" className='mr-2'/>
                    Download</button>
                </div>
              </div>
            </div>
