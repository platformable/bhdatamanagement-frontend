      ...
      <div className="mt-5 grid grid-cols-1 space-between gap-5">
        <div className="flex gap-x-5  items-center">
          ...
          <label className="m-5 flex items-center">
            <input type="radio" name="participantComfortSex" className="mr-2 w-4 h-4" onChange={(e) =>
        ...
        <div className="flex gap-x-5  items-center">
          ...
          <label className="m-5 flex items-center">
            <input type="radio" name="participantComfortMentalHealth" className="mr-2 w-4 h-4" onChange={(e) =>
          setSurveyForm((previous) => ({
            ...previous,
            [e.target.name]:e.target.value
          }))
        ...
        <div className="flex gap-x-5 items-center">
          ...
          <label className="m-5 flex items-center">
            <input type="radio" name="participantComfortDiet" className="mr-2 w-4 h-4" onChange={(e) =>
          setSurveyForm((previous) => ({
            ...previous,
            [e.target.name]:e.target.value
          }))
        ...
        <div className="flex gap-x-5  items-center">
          ...
          <label className="m-5 flex items-center">
          <input type="radio" name="participantComfortExercise" className="mr-2 w-4 h-4" onChange={(e) =>
          setSurveyForm((previous) => ({
            ...previous,
            [e.target.name]:e.target.value
          }))
        ...
        <div className="flex gap-x-5 items-center">
          ...
          <label className="m-5 flex items-center">
            <input type="radio" name="participantComfortHealth" className="mr-2 w-4 h-4" onChange={(e) =>
          setSurveyForm((previous) => ({
            ...previous,
            [e.target.name]:e.target.value
          }))
        ...
        <div className="flex gap-x-5  items-center">
          ...
          <label className="m-5 flex items-center">
            <input type="radio" name="participantComfortMedications" className="mr-2 w-4 h-4" onChange={(e) =>
          setSurveyForm((previous) => ({
            ...previous,
            [e.target.name]:e.target.value
          }))
        ...
        <div className="flex gap-x-5  items-center">
          ...
          <label className="m-5 flex items-center">
            <input type="radio" name="participantComfortSubstances" className="mr-2 w-4 h-4" onChange={(e) =>
          setSurveyForm((previous) => ({
            ...previous,
            [e.target.name]:e.target.value
          }))
